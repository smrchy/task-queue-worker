(function() {
  ...
  module.exports = TQWClient = (function(_super) {
    ...
    TQWClient.prototype._validateOptions = function() {
      var _ref;
      if (!((_ref = this.config.queue) != null ? _ref.length : void 0)) {
        this._handleError(false, "EMISSINGQUEUE");
      }
    };

    TQWClient.prototype.initialize = function(options) {
    ...
    TQWClient.prototype._send = function(msgData, cb) {
      var msg;
      msg = new this.Message(msgData);
      this.queue.send(msg, (function(_this) {
