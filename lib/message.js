(function() {
  var Request, methods, urlParser, utils, _,
  ...
  module.exports = function(options) {
    ...
    return Message = (function(_super) {
      ...
      function Message(data, meta, worker) {
        var _k, _v;
        this.meta = meta;
        this.worker = worker;
      ...
      Message.prototype.process = function(next, fail) {
      ...
      Message.prototype.defineProperties = function() {
        ...
        this.getter("httpHeaders", function() {
          return _this.data.headers;
        });
        this.getter("hasBody", function() {
          return _this.data.body != null;
        });
        this.getter("hasJSONBody", function() {
          return _this.data.hasJSONBody;
        });
        ["retrylimit", "retrydelay", "maxts", "timeout", "failqueue", "maxredirects"].forEach(function(_k) {
